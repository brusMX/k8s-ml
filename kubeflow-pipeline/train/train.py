...
external_trtis_resource_path = os.path.join(args.output_dir, 'trtis_resource')
if os.path.isdir(external_trtis_resource_path):
    shutil.rmtree(external_trtis_resource_path)
shutil.copytree(CONT_TRTIS_RESOURCE_PATH, external_trtis_resource_path)
...
def load_preprocessed_data(input_dir):
    ...
    preprocessed_data = x_train, y_train, x_test, y_test
